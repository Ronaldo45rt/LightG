...
const contractABI = require("../artifacts/contracts/Lightgbmpro.sol/Lightgbmpro.json").abi;

program
    .name("lightgbmpro-cli")
    .description("CLI tool for Lightgbmpro smart contract")
    .version("1.0.0");
